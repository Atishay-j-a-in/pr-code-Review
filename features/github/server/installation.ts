...
export async function saveInstallation(userId:string, installationId:number)
{
    ...
    await prisma.githubInstallation.upsert({
        where: { userId },
        update: { accountLogin, installationId, accountType: data.target_type?? null },
        create: { userId, accountLogin, installationId , accountType: data.target_type?? null},
    }) 
...
// TODO: delte the app from github
